...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for j in (0..IMG_HEIGHT_3).rev() {
        ...
        for i in 0..IMG_WIDTH_3 {
            ...
            {
                let u: f64 = (f64::from(i) + utilities_lib::generate_random_number::<f64>(0.0_f64,1.0_f64))/ f64::from(IMG_WIDTH-1);
                let v: f64 = (f64::from(j) + utilities_lib::generate_random_number::<f64>(0.0_f64,1.0_f64))/ f64::from(IMG_HEIGHT-1);
                let ray: Ray3D<f64> = camera.get_ray(u,v);
